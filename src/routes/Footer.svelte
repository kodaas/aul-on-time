...
<footer aria-label="Site Footer" class="bg-gray-100">
    ...
    >
      <div class="absolute top-4 right-4 sm:top-6 sm:right-6 lg:top-8 lg:right-8">
        <a
          class="inline-block rounded-full bg-primary p-2 text-white shadow transition hover:bg-teal-500 sm:p-3 lg:p-4"
          href="/dashboard/menu#header"
        >
      ...
      <div class="lg:flex lg:items-end lg:justify-between">
        <div>
          <div class="flex justify-center text-primary lg:justify-start">
            <img src={logo} width="30%" alt="Aul on Time">
          </div>
